...
## STATUS — 2026-08-18 (**Sprint #65 Skotsk terrier live og lukket** — raseguide #62, skotsk terrier-cluster #3 og clusterets sterkeste. TRIPPEL raseeksklusiv helse-moat, alle tre med navngitt primærstudie hentet fra Europe PMC-kjerneposter: von Willebrands sykdom type III (Venta 2000 J Vet Intern Med 14(1):10–19, enkeltbase-delesjon i kodon 85 av prepro-vWF, PCR-test som skiller fri/bærer/affisert; 87 hunder kartlagt, 15 bærere og 4 affiserte) + urotelialt karsinom i urinblæren (Knapp 2024 Vet J 303:106044, prospektiv kohort — **32 av 120 skotske terriere ≥6 år, 27 %**, fikk biopsibekreftet blærekreft på 3 års screening; passiv røyking OR 6,34 (1,16–34,69); støttet av Glickman 2004 fenoksyherbicider OR 4,42 og Raghavan 2005 grønnsaker OR 0,30) + Scottie cramp (Meyers 1969 JAVMA førstebeskrivelsen + Urkasemsin & Olby 2015 JSAP 56(4), 31 tilfeller, debut i første leveår hos 76 %). §9: **forhøyet ALP er rasetypisk, ikke Cushing** (Zimmerman 2018 Front Vet Sci, ~1 054 U/L mot referanse 8–70, men normal hypofyse–binyre-akse; SNP nær HSD17B2 på kromosom 5) — står i direkte spenning mot Norsk Terrier Klubs egen rasetekst, og den spenningen er selve poenget + CMO stratifisert (Hytönen 2016, 249 skotske terriere: 4 % homozygote alle affiserte, 17 % bærere hvorav 7 % affiserte — lekk spleisesete-mutasjon) + keisersnitt ved ca. halvparten av kullene. **NKK stiller ingen krav til hofte-, albue- eller DNA-status for rasen.** Levealder 12,7 år (McMillan 2024 Sci Rep, tilleggstabell S3, n=1 747) — lenger enn blandingshund (12,0) men kortest i terrier-clusteret (cairn 14,0, westie 13,4), alle med samme referansegruppe. Norsk virkelighet: **5 valper registrert i NKK i 2025, 0 i både 2019 og 2024**, mot cairn 99 og westie 13; i Storbritannia falt rasen fra over 5 800 valper i 1947 til 406 i 2023 og står på KCs «At Watch»-liste (300–450/år), **ikke** «Vulnerable». **2786 ord redaksjonelt / 3482 helhet.** Commits `2ac6757` + `ec875de`. **KENNEL-KRONOLOGIEN VERIFISERT MOT PRIMÆRKILDE** (FCI-standard nr. 73 i NKU-utgaven NKK selv utgir, + AKC): KC-klasser 1879, stambok 1880, første standard 1881, klubb 1882 — altså ~28 år før westien. **Fella er invertert mot #64:** der var «cairn som westiens forfar» anakronistisk og lett å avvise, her er «skotsk terrier som stamfar» kronologisk mulig og dermed fristende. 1879 er et skille, ikke et opphav; landrace-pool-formuleringen fra #63 er beholdt og utvidet. **FØRSTE SPRINT SOM HAR GÅTT HELE VEIEN GJENNOM BLINDKONTROLL-GATEN** — bestått uten faktafeil, med Venta 2000 og Knapp 2024 (OR 6,34 bekreftet eksakt) kryssjekket mot uavhengige kilder. **STEG 19 fant 3 avvik som null av de 18 strukturelle sjekkene så** (genusfeil, ulik tegnsetting for samme konstruksjon, og at `Article.headline` + brødsmulesteg 3 arver `page.title` fra Admin mens H1 er hardkodet). **Bevisst canonical-avvik, godkjent:** fila emitterer kun FAQPage inline — `theme.liquid:701` rendrer den globale brødsmule-snippeten på hver side, så cairn-malens inline BreadcrumbList er et duplikat. 56 av 62 raseguider har duplikatet, 6 har det ikke; #65 følger de 6. **#64 rettet stien, ikke duplikatet.** Rangeringspåstand droppet igjen: Knapp 2024s «20 ganger høyere» oppgir ingen sammenlikningsgruppe i sammendraget og fullteksten er betalingsmurt — blindkontrollen bekreftet at det var riktig kall. **62/100 raseguider live; 38 gjenstår.** Neste: #66 = raseguide #63; Skye Terrier er svak (0 NKK-registreringer 2025, ingen forskningsmoat) — polar spisshund-clusteret anbefales i stedet.)
