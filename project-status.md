...
## STATUS — 2026-08-19 (**Diaré hos hund live og lukket — første hundetips-artikkel gjennom hele 4-fase-protokollen.** Handle `diare-hund`, Helse, artikkel #62. 2840 ord redaksjonelt / 3263 helhet. Moatene: ENOVAT 2024-debunken (sterk anbefaling MOT antibiotika ved mild/moderat diaré, også blodig — høy evidenssikkerhet; VetCompass målte likevel 38 % antibiotikabruk), VetCompass 2025-epidemiologien (2,25 mill. hunder, 8,18 % årlig insidens = 1 av 12, 80,27 % trengte ett besøk) og det norske 2019-utbruddet (Jørgensen 2021: 511 hunder, 41 % P. alcalifaciens-positive, høstfenomen — VI/Mattilsynet/NMBU). Kildeseksjon (`mh-article__kilder`) VEDTATT for nye hundetips fra denne sprinten; 0 produktkort (YMYL-beslutning). **Protokoll-lagene leverte i tur:** rangeringsdetektor + superlativ-grep → 4 mykinger; dobbeltsjekk-pass i frisk subagent-kontekst → 18 funn (16 rettet, bl.a. Purina-avledet «48-timers»-tall og en answer-blokk som feilattribuerte årsaksliste til VetCompass); STEG 19 på rendret side → 2 avvik til (meningsglipp + genusfeil), fix-forward `4194d2b`. **Blindkontroll BESTÅTT uten faktafeil/kildefeil/presisjonsfeil** — ENOVAT-blodig-utvidelsen, Mohr 2003-tallene og Sartor/MDR1-kasuset uavhengig verifisert. Meta ×3 ordrett i live-head, H1 == Article.headline == brødsmule-ledd 4, én BreadcrumbList, hub-card_64, llms.txt ×3. Commits `409be73` + `4194d2b`; skill-oppgraderingen som muliggjorde sprinten: `a4b9da3` (4-fase-gates, blindkontroll-gate, dobbeltsjekk-pass, SEO/GEO-blokk, Phase 0 skill-skanning i BEGGE protokoller). ⏳ Malamute-sidecachen og ⛔ max_blocks-backloggen står uendret (se raseguider-STATUS); raseguide-teller 64/100 + lundehund-sprint pågår i parallell økt.)

### Innhold
- **62 hundetips-artikler** publisert i `/pages/hundetips`-hubben, fordelt på 5 kategorier (nyeste: diare-hund #62, Helse, 2026-08-19 — første artikkel under 4-fase-protokollen; talt fra `article_map` 2026-08-19):
  - Helse: 25 · Atferd: 18 · Stell: 7 · Aktivitet: 7 · Ernæring: 5
