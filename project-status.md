...
>
> **Sist generert:** 2026-09-18 kveld (**Turguiden tåler treg base på gren `treg-base` (`a05b09f`), ikke pushet — fylkessider, turdetalj (allSettled + 60 s revalidate ved ufullstendig rendring), fem OG-kort med reserve, forside `?tur=`, error.tsx/global-error.tsx. Tre Next-feller målt: fetch-dedupe slår ut nytt forsøk, `connection()` i ISR = 500, ISR-førsterendring viser Nexts innebygde 500.** Detaljer i STATUS 2026-09-18 kveld.)
>
