...
## STATUS — 2026-08-19 ettermiddag (**hund-halter live og lukket — hundetips-artikkel #63 (Helse), andre artikkel gjennom hele 4-fase-protokollen.** 3224 ord redaksjonelt / 3600 helhet, 11 H2 + 8 FAQ, triage-tabell (mobile-stack, 390px Playwright-verifisert), kildeseksjon, 0 produktkort (YMYL). **Kildegrunnlag: 10 kilder, alle åpnet/lest i Phase 2** — fire VetCompass-studier (Anderson 2018 artrose 2,5 %/OR 53,89 ≥12 år/OR 2,29 overvekt; Taylor-Brown 2015 korsbånd 0,56 %; O'Neill 2016 patella 1,30 %; O'Neill 2020 albue), NVT 2026 (anaplasmose — halthet bevisst nedtonet til «kan gi»), Veterinærinstituttet, Giftinformasjonen ×2 (paracetamol >75–100 mg/kg, ibuprofen >25 mg/kg), NMBU korsbåndsstudien (ordrett-sitat, randomisert 60 hunder 5–15 kg), DNV-spesialistjournal (panosteitt, kvalitativt). **Dobbeltsjekk-pass i frisk kontekst: 15 funn, 13 rettet, 2 falske positive pga. fasit-hull** (samme klasse som diaré). **STEG 19: 4 korrekturavvik funnet ved lesing, fix-forward samme økt.** **Blindkontroll bestått uten faktafeil, kildefeil eller presisjonsfeil** — kontrolløren re-verifiserte 0,56 %-sammentreffet (korsbånd og albue har identisk prevalens i to ulike studier — ren tilfeldighet, begge sjekket mot PubMed). GSC forespurt (gotcha #31-forbehold). Commits `4b42842` + `3d79d3d`. To utsatte enkeltrettinger notert i skill-STATUS: schäferhund panosteitt-spennet og «gratis å ringe» i hund-smerte-tegn.)
