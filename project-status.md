...
>
> **Sist generert:** 2026-09-21 natt (oppgave 11) (**Oppgave 11 — Turguiden-synlighet i én runde: punkt 0–7 levert og live, punkt 8 blokkert på tilgang.** `utm_content` er nå `<handle>-<plassering>` (bandtvang-norge gikk fra 2 til 8 unike verdier på 8 lenker); alle 39 A-sider har CTA-boks (sidebar 77 → 54); sidebar-CTA-en har fire temavarianter (bandtvang 35 · jakt 11 · vann 3 · helse 5) der jakt og helse peker på Turguidens kontoside; global GA4-lytter for `turguiden_cta_click` verifisert på seks flater; betinget linje i matkalkulatoren; vann-lenker fra vannkalkulatoren og `hund-drikker-ikke-pa-tur`; tidsavgrenset toppstripe som avløser «NY»-badgen 1. oktober (CLS 0,0000 på 390 px, ikke på /cart); varsel-punkt i llms.txt og norsk 404-side med søk (B14 lukket). **Gjenstår hos Sondre:** Custom Pixel 150765646 må abonnere på event-navnet, og `/turguiden`-redirecten må opprettes i Admin. Detaljer i STATUS-oppføringen 2026-09-21 natt (oppgave 11).)
> 
