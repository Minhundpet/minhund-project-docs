...
>
> **Sist generert:** 2026-09-04 natt (**Hundetips fase 2+3 pulje 1: sju kort migrert til `mh-product-callout` (snippeten fikk `article`/`eyebrow`), hvor-mye-mat og valp-biter = ingen fit; plan for alle 45 godkjent med ni avgjørelser.** Commit `deb5365`.)
>
