...
>
> **Forrige generering:** 2026-09-20 (**Turguiden-lenking runde 4 LIVE: varsel-CTA + inline tekstlenke på rad 9–15 av topp 15 A-sider — `flat-coated-retriever`, `norsk-elghund-gra`, `irsk-setter`, `newfoundland`, `flattmiddel-hund`, `engelsk-setter`, `strihaaret-vorstehhund`. Hele topp 15 er nå dekket (runde 2 `bf63677`, runde 3 `85f638f`). Ny UTM-regel: tekstlenke `utm_content=<handle>-inline`, boks `<handle>` — gordon/beagle rettet. To plasseringsavvik (flåttmiddel etter King-tipset, vorsteh etter §Temperament).** Detaljer i STATUS-oppføringen 2026-09-20 natt.)
>
