...
>
> **Sist generert:** 2026-09-23 (**Golden Retriever — leser-drevet retting LIVE (`95a86a3` + STEG 19 fix-forward `33b0301`), blindkontroll utestående.** Leserkommentaren fra 21.08 var allerede rettet i august; full audit fant likevel rest-avvik: irsk setter-tallet feilattribuert til Kent 2018, null nordiske kreftdata, ukildet vekt og levetid, McMillan-sammenligning på kryss av studier. Nytt: Bonnett 2005 + Engdahl 2025 (Agria) som nordisk feste, KC 2004-median, «typisk vekt» med FCI/AKC-forbehold, kildeseksjon med 19 kilder og 9 DOI-er i schema. STEG 19 fant at steg-blokken i §Pelsstell aldri hadde hatt CSS (løse sifre siden mai) — fikset. **Åpent:** live-meta (Admin) sier fortsatt «kreft» i overvekt-setningen — utkast levert; blindkontroll-pakke sendt til Sondre. Detaljer i raseguider/STATUS.md 2026-09-23.)
>
...
## STATUS — 2026-09-23 (Golden Retriever — leser-drevet retting) (**LIVE, blindkontroll utestående.** Oppdraget kom med leserkommentaren fra 21.08 som premiss; `git log` viste at begge punktene var rettet 22.–25.08, så auditen dekket hele guiden i stedet. Phase 1-rapport → STOP → godkjent (vekt beholdes som «typisk», kildeseksjon ja, råd-tall som råd) → Phase 2. To uavhengige lesninger i fersk kontekst (dobbeltsjekk før commit: 24 punkter, 9 rettet; STEG 19 på live-render: 21 avvik, fix-forward). Ordtall 3537 → 3871 redaksjonelt. GSC forespurt. Lærdom #52–#55 i sprint-lessons, gotcha #126. **Åpent for Sondre:** (1) blindkontroll — kun URL + nøytral instruks; (2) meta description i Admin — kreft-koblingen står der ennå, utkast på 152 tegn levert, settes med `metafieldsSet` ved ja.)
