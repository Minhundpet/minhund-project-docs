...
>
> **Forrige generering:** 2026-09-18 (**Turguiden-lenking runde 1 LIVE (`076bfdd`): UTM-standard via `snippets/turguiden-link.liquid`, varsel-CTA «Få varsel når båndtvangen starter der du bor» øverst + nederst i `bandtvang-norge`, ni brødtekst-lenker til fem DRAFT-produkter gjort betinget (gotcha #109: tomt produkt-drop er truthy med `available == true` — sjekk `!= blank`). llms.txt rettet til 7 318 turruter / 339 kommuner. Kartlegging + helsesjekk i `docs/turguiden-pa-minhundpet-kartlegging.md`.** Detaljer i STATUS-oppføringen 2026-09-18.)
>
