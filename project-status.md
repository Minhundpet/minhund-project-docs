...
>
> **Sist generert:** 2026-09-04 sen kveld (**Golden migrert — produktkort-utrullingen er komplett: 74 av 74 raseguider på malen (61 brødtekst-kort, 71 ett bunn-kort, 3 uten bunn-seksjon, 0 med tre). A/B-kortet på golden avlest i GA4 før fjerning: tapt måling (13 dagers levetid, én sosial trafikk-topp, og GA4 mangler egendefinerte dimensjoner for placement_type/position/breed_page — gotcha #92). Oktober-målingen krever at Sondre registrerer dimensjonene i GA4 først; de fyller ikke bakover.** Se STATUS og `docs/produktkort-utrulling.md`.)
>
