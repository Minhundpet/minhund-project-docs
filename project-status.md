...
>
> **Sist generert:** 2026-09-20 sen kveld (**Turguiden nød-ID-kort for hund BYGD på gren `nod-id-kort` (`626638d`, pushet) — IKKE live: venter på Googles godkjenning av Android-appen + at Sondre oppdaterer App Privacy/Data safety med telefonnummer, og at han limer inn migrasjonen `20260920190000_hund_nodkort.sql` selv. QR på selen → `/h/<kode>` med navn, bilde, rase, telefon, chip; av = 404; telefon ikke trykt på kortet.** Detaljer i STATUS 2026-09-20 sen kveld.)
>
