...
>
> **Sist generert:** 2026-09-23 natt (**Norsk Elghund Grå — leser-drevet retting LIVE (`b50e399`), venter på blindkontroll.** Oppfølging av Sort-saken: 23/20 kg var ukildet — FCI 242 oppgir kun høyde; NEKF sier hann rundt 21 / tispe rundt 18 kg, NJFF 18–25. I samme sveip: NM-brøkene (kildeløse) erstattet med NKKs regneark «Mest registrerte raser 2025» (NEG 563, 8. plass; jämthund 351); «750–1 200 valper» → NEKF ~750 / NKK 706-631-563 / RAS-snitt 948; levealder fikk primærkilde (Lingaas 2021 NEG-rapporten funnet via NES-rapportens URL-mønster: 122 døde hunder, snitt 10,6 år) med forbehold; HD «76,7 %» → Lingaas 81,5 % + NKK-krav A/B/C fra 01.04.2026; indeksavl 2016 (ikke 2018); glaukom 6,5 år (Ahonen 2014, DOI); gråhundsjuken «anekdotisk» etter NKK; «rektangulær profil» → «kvadratisk» (FCI); ny kildeseksjon med 12 kilder. Økta ble clearet etter godkjent Fase 1 — STEG 0 ved gjenopptak viste rent repo, ingenting pushet. Dobbeltsjekk i fersk kontekst: 14 funn rettet; STEG 19 på preview-render (cookie-jar, kontrolltest): 21 avvik rettet FØR live. sha256 MATCH, fersk render verifisert, `/llms.txt` 4850, GSC forespurt. Lærdom #61–#64 i raseguider/sprint-lessons.md. **Neste: blindkontroll → LUKKET.**)
>
