...
## STATUS — 2026-08-18 (**Sprint #64 Cairn Terrier live** — raseguide #61, skotsk terrier-cluster #2. TRIPPEL raseeksklusiv helse-moat: okulær melanose (Petersen-Jones 2007 Vet Ophthalmol, n=114, autosomalt dominant, firetrinns gradering; Winkler 2013 ekskluderte elleve kandidatgener; Winkler 2026 Vet Ophthalmol GWAS 63/31 kartla lokuset til 1,49 Mb på kromosom 11 = 86 % av tilfellene — fortsatt INGEN gentest) + medfødt portosystemisk shunt (van Straten 2005 J Vet Intern Med, 6 367 screenet / 58 affiserte, autosomal polygen) + globoid celle-leukodystrofi (Victoria 1996 Genomics GALC + Wenger 1999 J Hered). §9: CMO (Hytönen 2016 SLC37A2 c.1332C>T, rasetilhørighet bekreftet mot OMIA 002244) + PHTVL/HPV fra NTKs øyelysingsdata 2014 + Legg-Calvé-Perthes. **NKK stiller ingen krav til hofte-, albue- eller DNA-status for rasen** — verifisert mot begge kravdokumentene med kalibrert lokal PDF-parsing. RAS-tallene (registreringsfall 379→106, innavlsgrad 4,8 % mot NKKs 2,5 %) merket eksplisitt som historiske; dokumentet utløp 1.10.2020. **2602 ord redaksjonelt / 3192 helhet.** Commits `5f71b4f` + `276a46e` + `6a1a729`. **FØRSTE SPRINT ETTER PROSESSREVISJONEN** (`a09d945`, 17.08): egen 25-punkts raseguide-audit erstatter den lånte hundetips-lista, rangeringsdetektor obligatorisk i Phase 3 (0/0/0, kalibrert), STEG 19 flyttet til etter push + admin-opprettelse, meta godkjent i Phase 3, og to canonical-tillegg innført — answer-first-blokker (`mh-article__answer`) og nummerert kildeseksjon (`mh-article__kilder`) med DOI-lenker. **STEG 19 på ny plassering fant 6 avvik som NULL av de 25 strukturelle sjekkene så**, deriblant at `snippets/mh-breadcrumb-schema.liquid` manglet handelen og siden derfor serverte to motstridende brødsmulestier. Fila er nå lagt inn som fil 9 i sprintmønsteret og som sjekk 13 i auditen. **To feilattribusjoner fanget i research:** shunt-studien er van Straten (ikke van Steenbeek), Wenger er 1999 (ikke 1996). Rangeringspåstand om Legg-Calvé-Perthes droppet framfor å kildebelegges tynt. **61/100 raseguider live; 39 gjenstår.** Neste: #65 = raseguide #62, Scottish eller Skye Terrier.)
