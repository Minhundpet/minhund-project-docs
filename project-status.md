...
## STATUS — 2026-08-18 (**Sprint #66 Alaskan Malamute live og lukket** — raseguide #63, polar spisshund-cluster #2. **Moaten er at flaskehalsen forklarer sykdomsbildet:** AKC gjenåpnet stamboka på slutten av 1940-tallet fordi rasen nesten var borte etter krigstjeneste, og Jäderlund 2017 (Acta Vet Scand 59(1):26, n=114) kunne føre **samtlige** polynevropati-tilfeller tilbake til én felles nordamerikansk stamfar — arvestoff fra arkivert vev etter fem norske hunder syke på slutten av 1970-/1980-tallet bar nøyaktig samme mutasjon som de moderne tilfellene. **De første kjente tilfellene ble beskrevet i den NORSKE malamutepopulasjonen** (Bruun 2013 PLoS ONE 8(2):e54547 — NDRG1 Gly98Val, autosomal recessiv, 102 malamuter genotypet: 22 syke alle homozygote, 7 obligate bærere heterozygote, 201 hunder fra 38 andre raser alle frie; debut 3–19 md., median 13,5). Støttet av Skedsmo 2021 Neuromuscul Disord 31(1):56–68 (NDRG1-protein redusert >70 %, dog model of Charcot-Marie-Tooth type 4D, NMBU) og Hultman 2022 J Vet Intern Med 36(2):672–678 (tungeatrofi hos alle seks undersøkte hunder). §9: CNGB3 hel-gen-delesjon gir dagblindhet (Sidjanin 2002 Hum Mol Genet 11(16):1823–1833, ortolog til human akromatopsi ACHM3) + recessiv chondrodysplasi med forkortet erytrocyttlevetid (Fletch & Pinkerton 1972) + norske klubbtall: **1090 øyelyste 2007–2016, 51 med arvelig katarakt = 4,68 % av de øyelyste** (37,5 % undersøkt mer enn én gang — tallet gjelder undersøkte hunder, ikke rasen) og **902 av 2024 avkom HD-røntget: 85,4 % fri, 10 % svak, 3,22 % middels, 1,44 % sterk**. **REGULATORISK KORREKSJON MIDT I SPRINTEN:** gulmerkingen i NKKs DNA-PDF ble først lest programmatisk og tolket som at PN-testen er et registreringskrav. Visuell kontroll av den rendrede PDF-sida omgjorde det — raden er **ikke** gulmerket. Korrekt: NKK registrerer gentestsvaret sentralt i DogWeb, mens **kravet kommer fra NAMK** (retningslinje 5.4, gjeldende 01.06.2024: begge avlsdyr DNA-testet før paring, HD avlest A/B, øyelyst etter 22 md., min. 24 md., minimum Very Good). NKKs HD-krav fra **01.01.1989** er bekreftet visuelt; rasen står **ikke** i AD-lista. **Fraværs-blindsonen fra #64/#65 er dermed LØST — metoden er positiv kontrast i samme dokument:** raden er ufarget mens nabo-radene er gule, og tegnforklaringen definerer hva gult betyr, så kontrolløren ser dokumentet framfor å arve vår metode. **2695 ord redaksjonelt / 3388 helhet / 693 chrome.** Commits `11917e1` + `3563905` + `52caeaa`. **STEG 19 fant 7 avvik som null av de 25 strukturelle sjekkene så** — verst en ren meningsfeil («Gjerdet skal være høyt nok til å hoppe over» sa det motsatte av det som var ment), pluss to tall droppet fordi NAMKs trekkhund-tabell har 7 kolonneoverskrifter, 6 verdier og tom førstecelle. Nå 15 av 15 over tre sprinter der alle avvik kom fra lesing, ikke måling. **Blindkontroll bestått med ett reelt funn:** «de første tilfellene **i verden**» var vår slutning utover Bruun 2013s «in Norway» — mykt opp til «de første kjente tilfellene». Kontrollen verifiserte samtidig Bruun 2013 og Jäderlund 2017 eksakt mot primærkilde. **Article.headline == H1 på første forsøk** fordi Admin-sidetittelen ble oppgitt ordrett som eget felt i Phase 4-instruksen — #65-feilen unngått. Én BreadcrumbList, tre ledd, alle med `item`-URL. **63/100 raseguider live; 37 gjenstår.** Neste: #67 = raseguide #64 = **Grønlandshund**, clusterets siste — men advarsel: 61 NKK-registreringer i 2025 og praktisk talt ingen rasespesifikk helselitteratur, så moaten må bygges på arkeogenetikk og §8/§9 planlegges annerledes. **⛔ NY TOPPRIORITET I BACKLOG: `max_blocks: 75` i `sections/raseguider-grid.liquid` er ugyldig** — Shopify tillater maks 50, og `theme check` melder det som error. Ikke en render-grense i dag (63 av 63 hub-kort verifisert i live-HTML), men vi er 37 guider fra 100-målet og feilen ligger i temaet allerede.)
