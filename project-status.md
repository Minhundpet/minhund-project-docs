...
>
> **Sist generert:** 2026-09-04 kveld (**Ett produkt i bunn gjelder alle 74 raseguider — de 12 «ingen fit»-guidene trimmet: 10 live med ett bunn-kort (pelsfjerner 7, SnackSpin 2, TurPakken 1); whippet og greyhound har ingen forankret produkt og går til Sondre (fjerne bunn-seksjonen?). Westie (sak 2) trimmet til ett kort samme kveld: hundesengen beholdt, SnackSpin-tekstlenke avlenket. 71 av 74 har ett bunn-kort. Neste: golden i egen økt.** Se STATUS og `docs/produktkort-utrulling.md`.)
>
