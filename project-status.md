...
>
> **Sist generert:** 2026-09-01 kveld (**Konverterings-/trafikkaudit levert + forsidevideo byttet mot statisk bilde.** Audit (GA4 jun–aug, GSC, Shopify Admin, Lighthouse, crawl av kjøpsflyten): 8 638 sesjoner / 27 kjøp = 0,31 % (0,39 % uten bot). Kjøpsflyten er ikke problemet — PDP-landinger konverterer 5,9 %, checkout-fullføring 56 %, kun 3 forlatte checkouts på 60 d. Problemet er at 96 % av sesjonene aldri ser et produkt (artikkeltrafikk), fraktklippen 179 + 79 kr, og null kjøpsintensjons-trafikk (Ads 108 kr/30 d, kommersielle søk 0 klikk). Rangert liste i artefakt. Samme kveld: 43,9 MB autoplay-hero-video på forsiden byttet mot pelsfjerner-bildet som WebP (`56504f5`). Ekte throttlet LCP 9,4 s → 2,5–2,9 s; simulert/PSI-tall uendret ~10 s fordi den globale render-kjeden dominerer — se gotcha #83.)
>
