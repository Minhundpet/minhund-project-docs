...
## STATUS — 2026-08-18 (**Sprint #67 Grønlandshund live og lukket** — raseguide #64, og polar spisshund-clusteret er KOMPLETT (Samojedhund #59, Alaskan Malamute #63, Grønlandshund #64). **Første rene historie-moat i korpuset:** rasen har praktisk talt ingen rasespesifikk klinisk litteratur, så moaten ble bygget på arkeogenetikk-TRIPPELEN Sinding 2020 Science 368(6498):1495–1499 (9 500 år gammel sledehund fra Zhokhov-øya + ti moderne grønlandshunder + 33 000 år gammel sibirsk ulv; sledehund-haplotyper etablert for 9 500 år siden), Ameen 2019 Proc R Soc B 286(1916):20191929 (922 arktiske hunder/ulver over 4 500 år; inuit-hundene genetisk og morfometrisk distinkte fra paleo-inuit-hundene; ekspansjon fra ~1000 BP) og Feuerborn 2025 Science 389(6756):163–168 (Qimmeq-prosjektet: 92 genomer over ~800 år, to migrasjoner inn på Grønland, regionale bestander som speiler kulturell/språklig inndeling, minimal europeisk innblanding, begrenset nylig innavl tross lav heterozygositet; bestandsfall ~25 000 (2002) → ~13 000 (2020)). **§8/§9 uten klinisk litteratur løst med registerdata + positiv kontrast:** NKK HD-krav fra 01.01.1989 (PDF-til-bilde-verifisert), AD-lista i samme dokument og DNA-oversikten (versjon 10.02.2026) har ikke rasen; NPK-avlskrav HD A/B + tispe 24 md./hann 18 md. + maks 5 kull + utstilling min. «good»; NKK-raseomtalen «gjennomgående sunn rase» med ~10 % HD grad C–E siste tiår — **ordrett sitat fra NKKs raseside, kildetillit oppgradert av blindkontrollen** — og 61 NKK-registreringer 2025 hentet direkte fra statistikk-xlsx-en (stabil serie 50–87 siden 2010). Norsk historikk: til Norge rundt 1900 (NPK), Amundsen la ut mot polpunktet 20.10.1911 med fem mann, fire sleder og 52 grønlandshunder (polarhistorie.no), NKK-standard vedtatt 1935 (NPK-attribuert), Sirius-patruljen 12 mann/~69 hunder (forsvaret.dk), slededistrikt-loven LTL 18/1998 § 19. **2537 ord redaksjonelt / 3067 helhet / 530 chrome.** Commits `155a7ae` + `3d89657`. Selv-audit 25/25, rangeringsdetektor 0/0/0 etter kalibrering, og **manuelt superlativ-grep kjørt som fast steg for første gang** (6 treff — alle attribuerte sitater, dokumenttitler eller kontrast-dokumenterte). **STEG 19 fant 4 avvik som null strukturelle sjekker så — nå 19 av 19 over fire sprinter.** Verst: «NKK vedtok sin FØRSTE standard» der NPK bare sier «vedtatt av NKK i 1935» — samme vår-slutning-utover-kilden-klasse som #66s «i verden», men denne gangen fanget internt FØR blindkontrollen. **Blindkontrollen ble delvis: robots.txt blokkerte web-Claudes henting av selve siden** (første gang på fem sprinter, årsak ukjent — åpent punkt); kontrolløren verifiserte i stedet nøkkelpåstandene direkte mot NKKs raseside — mankehøyde 60/55, «gjennomgående sunn rase» og HD-10 %-tallet bekreftet ordrett, **ingen avvik i det kontrollerbare**; Science-tallene ble ikke uavhengig etterprøvd denne runden (lukket av Sondre på kildetype + track record). Article.headline == H1 på første forsøk (andre sprint på rad med Admin-sidetittel som eget felt), meta ×3 ordrett i live-head, hub-card_64 + llms.txt ×3 verifisert. **64/100 raseguider live; 36 gjenstår.** Alle tre sledehund-rasene krysslenket. Neste cluster velges på moat-tilgjengelighet (Skye Terrier fortsatt svak: 0 registreringer, ingen litteratur). ⏳ Malamute-sidecachen serverer fortsatt en pre-fix-snapshot (etag `page_cache`, CF DYNAMIC — Shopifys egen sidecache, ikke CDN-edge): #66-rettelsen og dagens back-link er begge pull-verifisert i temafila, men usynlige i render. Skotsk terrier-`page.title` er derimot konvergert (5/5 nye prøver). ⛔ max_blocks-backloggen står — nå 64 kort mot Shopify-maksimum 50 i schemaet, rendrer fortsatt.)
