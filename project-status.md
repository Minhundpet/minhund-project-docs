...
>
> **Sist generert:** 2026-09-21 natt (Turguiden uten produkter) (**Alle produkter er fjernet fra Turguiden, live på main (merge c891f5f).** Sondres beslutning: Turguiden skal bygge tillit og ikke oppleves som en butikk, og produktlenkene stoppet innlegg i flere Facebook-grupper. «Ta med på tur» (vannflaske + potevasker) på alle turdetaljsider, rekkefølgeregelen, de to produktfotoene og tre tester er slettet; bunnlenka byttet fra «Min Hund-butikken» → `/` til «Hundetips fra Min Hund» → `/pages/hundetips`. Artikkel- og raseguide-lenker til minhundpet.no beholdt. Verifisert live: 0 produkttreff på tursider, produktbilde 404, ny bunnlenke med UTM. Detaljer i STATUS-oppføringen 2026-09-21 natt (Turguiden uten produkter).)
> 
