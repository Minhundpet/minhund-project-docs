...
>
> **Sist generert:** 2026-08-25 (genpool-korreksjon på `golden-retriever` og `labrador-retriever` etter to brukerkommentarer 21.08 — ny feilklasse: amerikansk vs europeisk kildepopulasjon. Ligger verifisert på preview og venter på go for live-push)
>
